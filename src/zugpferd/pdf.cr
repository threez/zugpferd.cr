...
# PDF/A-3b embedding requires libharu >= 2.4 for OutputIntents and XMP support.
# Availability is detected via the LibHaru::OutputIntent type which is only bound on 2.4+.
